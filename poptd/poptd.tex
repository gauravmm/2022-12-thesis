...
- Sensetive to the  basis for the value function, not just the basis of $g$.
- Pathological value-bases for which this never works.
- Lottery-ticket bases which work until l = 1. (ie. The system is fairly easy to resample, and the amount of resampling isnt much, and so some bases work just fine.)
...
%#TODO: Mention that environment is resetting.
